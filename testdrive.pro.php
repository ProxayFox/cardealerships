			...
			<?php
				if ($result != FALSE) {
					while ($row = $result->fetch_row()) {
					 ...
					 ?>
					 	<td>
					 		<form action="testdrivebook.pro.php" method="POST" role="form" data-toggle="validator">
								<div class="col-auto my-1">
									<input name="carID" value="<?php echo $row[3]; ?>" type="hidden">
									<button class="btn btn-success" type="submit">
										Book
									</button>
								</div>
