			...
			<?php
				if ($result != FALSE) {
					while ($row = $result->fetch_row()) {
					 	echo '<tr><td scope="row">'.$row[0].'</td> <td><img src="./img/imges/'.$row[1].'" style="width: 100px;"></td> <td>'.$row[2].'</td> <td>$'.$row[3].'</td> <td>'.$row[4].'</td> <td> '.$row[5].'</td> <td>'.$row[6].'</td> <td>'.$row[7].'</td> <td>'.$row[8].'</td> <td>'.$row[9].'</td> <td>'.$row[10].'</td> <td>'.$row[11].'</td> <td>'.$row[12].'</td> <td>'.$row[13].'</td></tr>';
					} 
		} ?>
	</table>
</section>
